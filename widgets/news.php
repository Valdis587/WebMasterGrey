      ...
      <div class="sidebar__widget-wrapper">
            <ul class="sidebar__news-list">
                ...
                <?php
                    ...
                    ?>
                    <a class="sidebar__news-img" href="<?php the_permalink(); ?>"><img src="<?php echo $main[0]; ?>" alt="<?php the_title(''); ?>"></a>
                    <a class="btn-line sidebar__link" href="<?php the_permalink(); ?>"><?php the_title(''); ?></a>  
            </li>
                        <?php endwhile;
                    endif;
                    wp_reset_postdata();
