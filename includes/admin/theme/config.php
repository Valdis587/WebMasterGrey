...
$opt_name = 'websitesmaster';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'WebSitesMaster', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'WebSitesMaster', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Общие', 'your-textdomain-here' ),
		'id'               => 'obshie',
		'customizer_width' => '400px',
		'icon'             => 'el el-cog',
	)
);
require_once Redux_Core::$dir . '../theme/settings/logo.php';
require_once Redux_Core::$dir . '../theme/settings/title.php';
require_once Redux_Core::$dir . '../theme/settings/contacts.php';
require_once Redux_Core::$dir . '../theme/settings/head-page.php';
require_once Redux_Core::$dir . '../theme/settings/onas.php';

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Главная', 'your-textdomain-here' ),
		'id'               => 'home',
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
require_once Redux_Core::$dir . '../theme/home/slider.php';
require_once Redux_Core::$dir . '../theme/home/price.php';
require_once Redux_Core::$dir . '../theme/home/job.php';
require_once Redux_Core::$dir . '../theme/home/service.php';
require_once Redux_Core::$dir . '../theme/home/zak.php';
require_once Redux_Core::$dir . '../theme/home/faq.php';
require_once Redux_Core::$dir . '../theme/home/info.php';
require_once Redux_Core::$dir . '../theme/home/reviews.php';
require_once Redux_Core::$dir . '../theme/home/news.php';
...
require_once Redux_Core::$dir . '../theme/footer/title.php';
require_once Redux_Core::$dir . '../theme/footer/scripts.php';

require_once Redux_Core::$dir . '../theme/meta.php';
